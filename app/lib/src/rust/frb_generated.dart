...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => 1813282409;
...
abstract class RustLibApi extends BaseApi {
  ...
  Future<void> crateApiRadarInspectClose({required int session});

  Future<int> crateApiRadarInspectOpenCustom({required List<int> data});

  Future<int> crateApiRadarInspectOpenLevel2({
    required List<int> data,
    required String moment,
    required int elevationIndex,
  });

  Future<int> crateApiRadarInspectOpenLevel3({required List<int> data});
  ...
  Future<Float64List> crateApiRadarInspectSite({required int session});
  ...
  Future<RadarFrame> crateApiRadarRenderCapeView({
    required List<int> data,
    required double north,
    required double south,
    required double east,
  ...
  Future<RadarFrame> crateApiRadarRenderOpenFrame({
    required List<int> data,
    required int imageSize,
  });

  Future<RadarFrame> crateApiRadarRenderOpenView({
    required List<int> data,
    required double north,
    required double south,
    required double east,
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<void> crateApiRadarInspectClose({required int session}) {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiRadarInspectCloseConstMeta,
        argValues: [session],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiRadarInspectCloseConstMeta =>
      const TaskConstMeta(debugName: "inspect_close", argNames: ["session"]);
  ...
  Future<int> crateApiRadarInspectOpenCustom({required List<int> data}) {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiRadarInspectOpenCustomConstMeta,
        argValues: [data],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiRadarInspectOpenCustomConstMeta =>
      const TaskConstMeta(debugName: "inspect_open_custom", argNames: ["data"]);
  ...
  TaskConstMeta get kCrateApiRadarInspectSiteConstMeta =>
      const TaskConstMeta(debugName: "inspect_site", argNames: ["session"]);
  ...
  Future<List<MesoHit>> crateApiRadarMesocyclones({required List<int> data}) {
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_list_meso_hit,
          decodeErrorData: sse_decode_String,
        ),
        constMeta: kCrateApiRadarMesocyclonesConstMeta,
        argValues: [data],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiRadarMesocyclonesConstMeta =>
  ...
  Future<ColorScale> crateApiRadarOpenColorScale({required List<int> data}) {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiRadarOpenColorScaleConstMeta,
        argValues: [data],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiRadarOpenColorScaleConstMeta =>
      const TaskConstMeta(debugName: "open_color_scale", argNames: ["data"]);
  ...
  Future<RadarFrame> crateApiRadarRenderCapeView({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiRadarRenderCapeViewConstMeta,
  ...
  TaskConstMeta get kCrateApiRadarRenderCapeViewConstMeta =>
      const TaskConstMeta(
        debugName: "render_cape_view",
  ...
  Future<RadarFrame> crateApiRadarRenderOpenFrame({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiRadarRenderOpenFrameConstMeta,
        argValues: [data, imageSize],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiRadarRenderOpenFrameConstMeta =>
      const TaskConstMeta(
        debugName: "render_open_frame",
        argNames: ["data", "imageSize"],
      );
  ...
  Future<RadarFrame> crateApiRadarRenderOpenView({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiRadarRenderOpenViewConstMeta,
        argValues: [data, north, south, east, west, width, height],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiRadarRenderOpenViewConstMeta =>
      const TaskConstMeta(
        debugName: "render_open_view",
        argNames: ["data", "north", "south", "east", "west", "width", "height"],
      );
  ...
  @protected
  List<MesoHit> dco_decode_list_meso_hit(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>).map(dco_decode_meso_hit).toList();
  }
  ...
  @protected
  MesoHit dco_decode_meso_hit(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    final arr = raw as List<dynamic>;
    if (arr.length != 9)
    ...
    return MesoHit(
      ...
      stormId: dco_decode_String(arr[4]),
      maxRvKt: dco_decode_f_32(arr[5]),
      tvs: dco_decode_bool(arr[6]),
      msi: dco_decode_i_32(arr[7]),
      motion: dco_decode_String(arr[8]),
    );
  }
  ...
  @protected
  List<MesoHit> sse_decode_list_meso_hit(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs

    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <MesoHit>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_meso_hit(deserializer));
    }
    return ans_;
  }
  ...
  @protected
  MesoHit sse_decode_meso_hit(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    ...
    var var_stormId = sse_decode_String(deserializer);
    var var_maxRvKt = sse_decode_f_32(deserializer);
    var var_tvs = sse_decode_bool(deserializer);
    var var_msi = sse_decode_i_32(deserializer);
    var var_motion = sse_decode_String(deserializer);
    return MesoHit(
      id: var_id,
      lat: var_lat,
      lon: var_lon,
  ...
  @protected
  void sse_encode_list_meso_hit(List<MesoHit> self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_meso_hit(item, serializer);
    }
  }
  ...
  @protected
  void sse_encode_meso_hit(MesoHit self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_String(self.id, serializer);
    sse_encode_f_64(self.lat, serializer);
    sse_encode_f_64(self.lon, serializer);
    sse_encode_String(self.rank, serializer);
    sse_encode_String(self.stormId, serializer);
    sse_encode_f_32(self.maxRvKt, serializer);
    sse_encode_bool(self.tvs, serializer);
    sse_encode_i_32(self.msi, serializer);
    sse_encode_String(self.motion, serializer);
  }
