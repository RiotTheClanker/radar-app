...
| [addons.md](addons.md) | You are writing an addon — sites, overlays, places, themes — or changing the loader |
| [open-format.md](open-format.md) | You have radar data in a format the app does not decode, and your own parser for it |
