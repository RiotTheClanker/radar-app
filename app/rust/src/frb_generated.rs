...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -2082822341;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        9 => wire__crate__api__radar__render_mrms_view_impl(port, ptr, rust_vec_len, data_len),
        10 => wire__crate__api__radar__render_volume3d_impl(port, ptr, rust_vec_len, data_len),
        11 => wire__crate__api__radar__sample_level2_impl(port, ptr, rust_vec_len, data_len),
        12 => wire__crate__api__radar__sample_level3_impl(port, ptr, rust_vec_len, data_len),
        13 => {
            wire__crate__api__radar__volume3d_ground_bounds_impl(port, ptr, rust_vec_len, data_len)
        }
        14 => wire__crate__api__radar__volume3d_open_impl(port, ptr, rust_vec_len, data_len),
        15 => wire__crate__api__radar__volume3d_render_fly_impl(port, ptr, rust_vec_len, data_len),
        16 => wire__crate__api__radar__volume3d_set_ground_impl(port, ptr, rust_vec_len, data_len),
        17 => {
